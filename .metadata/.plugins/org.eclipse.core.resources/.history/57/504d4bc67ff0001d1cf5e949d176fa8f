...
<body>
	...
	<h4>1. 기존의 include 지시어를 이용한 방식 (정적 include방식 - 컴파일시 포함)</h4>
	<%-- 
	...
	<!-- 반드시 시작태그와 종료태그를 같이 사용해야한다 (xml기술)
		단, 시작태그와 종료태그 사이에 넣을 값이 없다면 하나로 표기하는 방법 <태그/> 이렇게 표현한다. 
		 -->
	<jsp:include page="footer.jsp"/>
	<br><br>
	특징 1 : include 하고 있는 페이지에 선언된 변수를 공유하지 않는다(동일한 이름의 변수 선언 가능 )<br>
	<%String year ="2024"; %>
	<br>
	특징2 : 포함 시 include하는 페이지로 값을 전달할 수 있다. <br>
	<jsp:include page="footer.jsp">
