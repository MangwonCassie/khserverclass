 ...
 * Generated at: 2023-05-10 07:51:07 UTC
...
if(loginUser == null) {
      ...
      out.write("                <td colspan=\"3\">\r\n");
      out.write("                    	<!-- 첨부파일이 없을 경우 : 첨부파일이 없습니다. -->\r\n");
      out.write("                    	");
if(at == null) {
      out.write("\r\n");
      ...
      out.write("	                    	<a href=\"");
      out.print(contextPath + at.getFilePath()+"/"+at.getChangeName());
      out.write("\" download=\"");
...
if(loginUser != null && loginUser.getUserId().equals(b.getBoardWriter())){ 
      ...
      out.write("'\" class=\"btn btn-info\">수정하기</button>\r\n");
      out.write("	        	<button onclick=\"location.href='");
      out.print(contextPath);
      out.write("/delete.bo?bno=");
      out.print(b.getBoardNo());
      out.write("'\" class=\"btn btn-danger\">삭제하기</button>\r\n");
      out.write("	        	<!-- get방식으로 처리 -->\r\n");
      out.write("	        </div>\r\n");
      out.write("        ");
} 
      out.write("\r\n");
...
if(loginUser != null) {
      ...
      out.write("        				<td><textarea id=\"reply\" rows=\"3\" cols=\"50\" style=\"resize:none\"></textarea></td>\r\n");
      ...
      out.write("        			<tr>\r\n");
      out.write("        				<th>댓글작성</th>\r\n");
      out.write("        				<td><textarea rows=\"3\" cols=\"50\" style=\"resize:none\" disabled>로그인 후 이용 가능한 서비스입니다.</textarea></td>\r\n");
      out.write("        				<td><button onclick=\"insertReply()\">로그인했다치는버튼</button></td>\r\n");
      out.write("        			</tr>\r\n");
      out.write("        		\r\n");
      out.write("        		\r\n");
      out.write("        		");
      ...
      out.write("        			<tr >\r\n");
      out.write("        			<!--  댓글 목록이 여기에 추가됨 -->\r\n");
      out.write("        				<td>admin</td>\r\n");
      out.write("        				<td>강쥐가 귀엽네요</td>\r\n");
      out.write("        				<td>2023/04/13</td>\r\n");
      out.write("        						\r\n");
      out.write("        			</tr>\r\n");
      out.write("        			\r\n");
      out.write("        		\r\n");
      ...
      out.write("        			//댓글 삽입\r\n");
      out.write("        			//게시글 번호 (들고가야함)\r\n");
      out.write("        			//성공시에는 댓글 리스트 조회함수 실행 후 textarea비워주기\r\n");
      out.write("					//insert근데 새로고침해야함.\r\n");
      out.write("        			$.ajax({\r\n");
      out.write("        			\r\n");
      out.write("        				url: \"insert.rp\", \r\n");
      out.write("        				data: {\r\n");
      out.write("        					currentBoardNo:  ");
      out.print(b.getBoardNo());
      out.write(",\r\n");
      out.write("        					replyContent :$(\"#reply\").val(),\r\n");
      ...
      out.write("        					\r\n");
      out.write("        					 // 댓글 리스트 조회 함수 실행 후 textarea 비우기\r\n");
      ...
      out.write("                //댓글 목록 조회\r\n");
      out.write("                //조회해온 데이터를 tdody에 tr로 출력해주기(반복문)\r\n");
      out.write("                \r\n");
      out.write("                ");
if(loginUser != null ){
      out.write(" \r\n");
      out.write("                  $(\"#replyList\").show();\r\n");
      out.write("                ");
} else{
      out.write("\r\n");
      out.write("                  $(\"#replyList\").hide();\r\n");
      out.write("                ");
}
      out.write("\r\n");
      out.write("                \r\n");
      out.write("                $.ajax({\r\n");
      out.write("                    url:\"select.rp\",\r\n");
      out.write("                    data:{currentBoardNo:  ");
      out.print(b.getBoardNo());
      out.write("},\r\n");
      out.write("                    type:\"get\",\r\n");
      out.write("                    success: function(list){\r\n");
      ...
      out.write("                        var str = \"\";\r\n");
      out.write("                        //댓글목록 순회하며 HTML태그 추가\r\n");
      out.write("                        //size로 하면 안됨 \r\n");
      out.write("                       	for( var i =0; i<list.length; i++){\r\n");
      out.write("                        	str+=\r\n");
      out.write("                        	\"<tr>\"\r\n");
      out.write("                        	+\"<td>\"+list[i].replyWriterS+\"</td>\"\r\n");
